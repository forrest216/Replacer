	...
	// Top section - question header and description
	{
		...
		"infoDet": [{
			"topBody":[{
				...
				"bodyDesc":"<p>We hope you love what you ordered. But in case you don't&mdash;perhaps it's a little too big or the style just isn't you&mdash;we'll send you a new size, color, or style, or issue you a quick refund. Returns and exchanges are free when you use our prepaid return shipping label or when you return in store. You have up to 45 days to return items purchased at Gap, Old Navy and Banana Republic. Items purchased from Athleta and Hill City may be returned at any time. Full details of all our return polices can be found on our <a style=\"text-decoration:underline;\" href=\"/customerService/info.do?cid=81264&cs=return_policies\">‘Return Policies’</a> page.</p><p><a href='/customerService/info.do?cid=81264&cs=gifts'>Returning or exchanging a gift?</a></p>"
			}]
		}]
	},
	// Body - includes
					...
					"bodyDetail":[
						{
							...
							"detailHead":"Get your return label ready",
							"detailDesc":"<p>To begin your return and create a prepaid UPS or USPS label, use our <a href='https://returns.narvar.com/gap/returns' target='_new'>interactive returns process.</a></p>"
						},

						{
							...
							"detailDesc":"<ul class='alphaList2' style='margin-left:15px'><li class='step_bwA'>Pack your return securely, in the original package if possible, and include your packing slip (generated via the interactive returns process).<\/li><li class='step_bwB'>Affix your shipping label to the package, making sure no other tracking labels are showing.<\/li><\/ul>"
						},
						{
							"detailIcon":[{
			...
			"subBody":[{
				...
				"topicBody":[{
					"bodyDetail":[{
						...
						"detailHead":"",
						"detailDesc":"<p>To create a prepaid UPS and USPS return shipping label, use our <a href='https://returns.narvar.com/gap/returns' target='_new'>interactive returns process.</a></p><p>If you prefer, you can send your returned item, postage prepaid, to this address:<\/p><p style='padding-left:15px'>100 Gap Inc. Direct Gateway<br\/>Groveport, OH 43125<\/p><p>Be sure to include your packing slip (generated via the interactive returns process). It’s also a good idea to write down your delivery tracking number for future reference.<\/p><p>NOTE: We do not accept C.O.D. deliveries.  If you choose not to use our pre-paid shipping label, shipping is at your expense. Also, we don't refund original shipping and handling charges.<\/p>"
					}],  // end bodyDetail
					// start of the addDetail
					"bodyAddDetail":""
				}] //end topicBody
