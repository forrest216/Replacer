					...
					"bodyDetail":[
						{
							...
							"detailDesc":"<p>To begin your return and create a prepaid UPS or USPS label, use our <a href='http://returns.narvar.com/gap' target='_new'>interactive returns process.</a></p>"
						},

						{
							...
							"detailDesc":"<ul class='alphaList2' style='margin-left:15px'><li class='step_bwA'>Pack your return securely, in the original package if possible, and include your completed invoice.<\/li><li class='step_bwB'>Affix your shipping label to the package, making sure no other tracking labels are showing.<\/li><\/ul>"
						},
						{
							"detailIcon":[{
		...
		{ // to add / subtract section, select from this point....
			...
			"subBody":[{
				"topicBanner":[{
					...
					"title":"To exchange items purchased from more than one brand",
					"titleLink":""
				}],//end topicBanner
				"topicDesc":"",
				"topicBody":[{
			...
			"subBody":[{
				...
				"topicBody":[{
					"bodyDetail":[{
						...
						"detailHead":"",
						"detailDesc":"<p>To create a prepaid UPS and USPS return shipping label, use our <a href='http://returns.narvar.com/gap' target='_new'>interactive returns process.</a></p><p>If you prefer, you can send your returned item, postage prepaid, to this address:<\/p><p style='padding-left:15px'>100 Gap Inc. Direct Gateway<br\/>Groveport, OH 43125<\/p><p>Be sure to include your invoice, with information about your returned item as described in the topics above. It's also a good idea to write down your delivery tracking number for future reference.<\/p><p>NOTE: We do not accept C.O.D. deliveries.  If you choose not to use our pre-paid shipping label, shipping is at your expense. Also, we don't refund original shipping and handling charges.<\/p>"
					}],  // end bodyDetail
					// start of the addDetail
					"bodyAddDetail":""
				}] //end topicBody
